...
const pixiVersionHelper = {
  ...
  semanticVersion() {
    ...
    if (semVer.length < 3) { return { major:0, minor:0, patch:0 }; }
  ...
  major() { return this.semanticVersion().major; },
  minor() { return this.semanticVersion().minor; },
  patch() { return this.semanticVersion().patch; },
